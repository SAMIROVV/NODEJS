...
const Request = require('request');
	...
	Request.post({url: 'https://countwordsfree.com/loadweb', json: false, body: {"url":decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[0].replace('/SCRAPER3?','') }}, (err, res, body) => {	
