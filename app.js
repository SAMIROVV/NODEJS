...
//const fetch = require('node-fetch');
                ...
                https.get({url:url.format({ hostname: 'trends.google.com/', pathname: 'trends/api/widgetdata/multiline', query: {hl: req0.query.hl, tz: tz, req: JSON.stringify(obj.widgets[0].request), token: obj.widgets[0].token,tz: tz} })}, (res) => {  
