...
https.get(decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[0].replace('/SCRAPER4?','')   , (res) => {  
                    let data = '';
                    res.on('data', (chunk) => {data += chunk; });
                    res.on('end', () => {res0.header('Content-Type', 'application/json').send(JSON.parse(data)[keyword1].queries[keyword1].top.map(function (item) {  return item.query+'☔☉'+item.value+'💙💔'})+'🔰↕'+JSON.parse(data)[keyword1].queries[keyword1].rising.map(function (item) {  return item.query+'☔☉'+item.value+'💙💔'})+'🔹🔸'+   Object.values(JSON.parse(data)[keyword1].topics[0]).map(function (item) {  return item.topic_title+'☔☉'+item.topic_type+'☔☉'+item.value+'💙💔'})+'🔰↕'+Object.values(JSON.parse(data)[keyword1].topics[1]).map(function (item) {  return item.topic_title+'☔☉'+item.topic_type+'☔☉'+item.value+'💙💔'})   +'🔹🔸'+Object.values(JSON.parse(data)[keyword1].trends)   .map(function (item) {  return item[keyword1]+'💙💔'})      +'🔹🔸'+ Object.keys(JSON.parse(data)[keyword1].region)+'🔹🔸'+Object.values(JSON.parse(data)[keyword1].region.map(function (item) {  return item[]+'💙💔'})   ).map(function (item) {  return item[keyword1]+'💙💔'})     )       				    
});}); }
...
https.get(decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[0].replace('/SCRAPER4?','')   , (res) => {  
                    let data = '';
                    res.on('data', (chunk) => {data += chunk; });
                    res.on('end', () => {res0.header('Content-Type', 'application/json').send(JSON.parse(data)[keyword1].queries[keyword1].top.map(function (item) {  return item.query+'☔☉'+item.value+'💙💔'})+'🔰↕'+JSON.parse(data)[keyword1].queries[keyword1].rising.map(function (item) {  return item.query+'☔☉'+item.value+'💙💔'})+'🔹🔸'+   Object.values(JSON.parse(data)[keyword1].trends)   .map(function (item) {  return item[keyword1]+'💙💔'})      +'🔹🔸'+ Object.keys(JSON.parse(data)[keyword1].region+'💙💔')+'🔹🔸'+Object.values(JSON.parse(data)[keyword1].region).map(function (item) {  return item[keyword1]+'💙💔'})+            			    
			                                                                 '💚'+JSON.parse(data)[keyword2].queries[keyword2].top.map(function (item) {  return item.query+'☔☉'+item.value+'💙💔'})+'🔰↕'+JSON.parse(data)[keyword2].queries[keyword2].rising.map(function (item) {  return item.query+'☔☉'+item.value+'💙💔'})+'🔹🔸'+   Object.values(JSON.parse(data)[keyword2].trends)   .map(function (item) {  return item[keyword2]+'💙💔'})      +'🔹🔸'+ Object.keys(JSON.parse(data)[keyword2].region+'💙💔')+'🔹🔸'+Object.values(JSON.parse(data)[keyword2].region).map(function (item) {  return item[keyword2]+'💙💔'})     )       
});});}
...
https.get(decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[0].replace('/SCRAPER4?','')   , (res) => {  
                    ...
                    res.on('end', () => {res0.header('Content-Type', 'application/json').send(JSON.parse(data)[keyword1].queries[keyword1].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword1].queries[keyword1].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword1].trends)   .map(function (item) {  return item[keyword1]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword1].region)+'↕'+Object.values(JSON.parse(data)[keyword1].region).map(function (item) {  return item[keyword1]})         			    
			                                                                +'💚'+JSON.parse(data)[keyword2].queries[keyword2].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword2].queries[keyword2].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword2].trends)   .map(function (item) {  return item[keyword2]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword2].region)+'↕'+Object.values(JSON.parse(data)[keyword2].region).map(function (item) {  return item[keyword2]})         
                                                                                        +'💚'+JSON.parse(data)[keyword3].queries[keyword3].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword3].queries[keyword3].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword3].trends)   .map(function (item) {  return item[keyword3]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword3].region)+'↕'+Object.values(JSON.parse(data)[keyword3].region).map(function (item) {  return item[keyword3]})     )     
});});}
...
https.get(decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[0].replace('/SCRAPER4?','')   , (res) => {  
                    ...
                    res.on('end', () => {res0.header('Content-Type', 'application/json').send(JSON.parse(data)[keyword1].queries[keyword1].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword1].queries[keyword1].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword1].trends)   .map(function (item) {  return item[keyword1]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword1].region)+'↕'+Object.values(JSON.parse(data)[keyword1].region).map(function (item) {  return item[keyword1]})          			    
			                  +'💚'+JSON.parse(data)[keyword2].queries[keyword2].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword2].queries[keyword2].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword2].trends)   .map(function (item) {  return item[keyword2]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword2].region)+'↕'+Object.values(JSON.parse(data)[keyword2].region).map(function (item) {  return item[keyword2]})       
                                          +'💚'+JSON.parse(data)[keyword3].queries[keyword3].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword3].queries[keyword3].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword3].trends)   .map(function (item) {  return item[keyword3]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword3].region)+'↕'+Object.values(JSON.parse(data)[keyword3].region).map(function (item) {  return item[keyword3]})      
                                          +'💚'+JSON.parse(data)[keyword4].queries[keyword4].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword4].queries[keyword4].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword4].trends)   .map(function (item) {  return item[keyword4]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword4].region)+'↕'+Object.values(JSON.parse(data)[keyword4].region).map(function (item) {  return item[keyword4]})     )       
});});}
...
https.get(decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[0].replace('/SCRAPER4?','')   , (res) => {  
                    ...
                    res.on('end', () => {res0.header('Content-Type', 'application/json').send(JSON.parse(data)[keyword1].queries[keyword1].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword1].queries[keyword1].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword1].trends)   .map(function (item) {  return item[keyword1]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword1].region)+'↕'+Object.values(JSON.parse(data)[keyword1].region).map(function (item) {  return item[keyword1]})          			    
			                  +'💚'+JSON.parse(data)[keyword2].queries[keyword2].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword2].queries[keyword2].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword2].trends)   .map(function (item) {  return item[keyword2]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword2].region)+'↕'+Object.values(JSON.parse(data)[keyword2].region).map(function (item) {  return item[keyword2]})     
                                          +'💚'+JSON.parse(data)[keyword3].queries[keyword3].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword3].queries[keyword3].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword3].trends)   .map(function (item) {  return item[keyword3]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword3].region)+'↕'+Object.values(JSON.parse(data)[keyword3].region).map(function (item) {  return item[keyword3]})         
                                          +'💚'+JSON.parse(data)[keyword4].queries[keyword4].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword4].queries[keyword4].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword4].trends)   .map(function (item) {  return item[keyword4]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword4].region)+'↕'+Object.values(JSON.parse(data)[keyword4].region).map(function (item) {  return item[keyword4]})           
                                          +'💚'+JSON.parse(data)[keyword5].queries[keyword5].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[keyword5].queries[keyword5].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[keyword5].trends)   .map(function (item) {  return item[keyword5]})      +'🔰'+ Object.keys(JSON.parse(data)[keyword4].region)+'↕'+Object.values(JSON.parse(data)[keyword4].region).map(function (item) {  return item[keyword5]})     )       
});});}
