...
var dat = if(JSON.parse(data.slice(4)).widgets.filter(function(o){    return (o.id === 'GEO_MAP')})===''){JSON.STRINGIFY(JSON.parse(data.slice(4)).widgets.filter(function(o){    return (o.id === 'GEO_MAP')}))}else{JSON.parse(data.slice(4)).widgets.filter(function(o){    return (o.id === 'GEO_MAP')})};
console.log(dat);
