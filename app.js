...
app.get('/SCRAPER4', (req0, res0) => {
	...
	var keyword2 = decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[1];
	var keyword1 = decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[2];
...
//res.on('end', () => {res0.header('Content-Type', 'application/json').send('💚'+JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].queries[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].top.map(function (item) {  return item.query+'☉'+item.value})+'↕'+JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].queries[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].rising.map(function (item) {  return item.query+'☉'+item.value})+'🔰'+   Object.values(JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].topics[0]).map(function (item) {  return item.topic_title+'☉'+item.topic_type+'☉'+item.value})+'↕'+Object.values(JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].topics[1]).map(function (item) {  return item.topic_title+'☉'+item.topic_type+'☉'+item.value})   +'🔰'+Object.values(JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].trends)   .map(function (item) {  return item[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]]})      +'🔰'+ Object.keys(JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].region)+'↕'+Object.values(JSON.parse(data)[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]].region).map(function (item) {  return item[decodeURIComponent(url.format({ pathname: req0.originalUrl })).split("☆")[i]]})     )       
//res.on('end', () => {console.log('fafa:', keyword2);console.log('fafa2:', keyword1);
